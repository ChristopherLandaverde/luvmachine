    ...
    <>
      ...
      <main className={`${inter.className} bg-secondary pt-36`}>
        <div className="mb-36">
          ...
          <h1 className={`text-6xl font-bold text-center mb-6 ${dancingScript.className}`}>
            Luv Machine
          </h1>
          ...
          <div className="text-center">
            <button className="text-white bg-primary p-4 rounded-full text-lg w-[200px]">Get started</button>
          </div>
        </div>
        <div className="p-4">
